	...
	<div class="cart_section">
		<div class="container">
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					<div class="cart_container">
						<div class="cart_title"><center>Keranjang Belanja</center></div>
	         								    ...
	         								    <div class="table-responsive">
									                    ...
									                    <tbody>
									                        ...
									                        <tr>
									                            ...
									                            <td class="text-right">
									                            	<form action="{{ url('/frontend/cart', [$item->rowId]) }}" method="POST" class="side-by-side">
										                                {!! csrf_field() !!}
										                                <input type="hidden" name="_method" value="DELETE">
										                                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin menghapus produk ini dari keranjang?')"><i class="fa fa-trash"></i> Hapus</button>
										                            </form>
										                            <br>
										                            <form action="{{ url('/frontend/switchToWishlist', [$item->rowId]) }}" method="POST" class="side-by-side">
										                                {!! csrf_field() !!}
										                                <button type="submit" class="btn btn-success btn-sm" onclick="return confirm('Anda yakin menambah produk ini ke favorit?')"><i class="fa fa-shopping-cart"></i> Tambah ke Favorit</button>
										                            </form>
									                            </td>
									                        </tr>
									                        @endforeach
									                        <tr>
									                            ...
									                            <td></td>
									                            <td>
									                            	<form action="{{ url('/frontend/emptyCart') }}" method="POST">
													                    {!! csrf_field() !!}
													                    <input type="hidden" name="_method" value="DELETE">
													                    <button type="submit" class="btn btn-danger btn-sm btn-block" onclick="return confirm('Anda yakin mengosongkan keranjang?')">Kosongkan Keranjang</button>
													                </form>
									                        ...
									                        <tr>
									                            ...
									                            <td class="text-center" style="width: 200px;"><strong>Rp. {{ Cart::instance('default')->subtotal() }}</strong></td>
									                            <td></td>
									                        </tr>
									                    </tbody>
									                </table>
									            ...
									            <div class="row">
									                ...
									                @if(sizeof(Cart::content()) > 0)
										                <div class="col-sm-12 col-md-6 text-right">
										                    <a href="{{ url('/frontend/checkout') }}"><button class="btn btn-block btn-block btn btn-primary">Bayar</button></a>
										                </div>
									                @else
									                	<div class="col-sm-12 col-md-6 text-right">
										                    <button class="btn btn-block btn-block btn btn-primary">Bayar</button>
										                </div>
										            @endif
									            </div>
									        </div>
