<?php namespace App\Http\Controllers;
	...
	class AdminTbLokasiProduksController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "nama_lokasi";
			$this->limit = "20";
			...
			$this->table = "tb_lokasi_produks";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Nama Lokasi","name"=>"nama_lokasi"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Nama Lokasi','name'=>'nama_lokasi','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Alamat','name'=>'alamat','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Kota','name'=>'id_kota','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'tb_master_kotas,nama'];
			$this->form[] = ['label'=>'Nama Lokasi','name'=>'kota','type'=>'hidden','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Kode Pos','name'=>'kode_pos','type'=>'hidden','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Maps','name'=>'maps','type'=>'googlemaps','validation'=>'required','width'=>'col-sm-10','latitude'=>'latitude','longitude'=>'longitude'];
			$this->form[] = ['label'=>'Deskripsi','name'=>'deskripsi','type'=>'wysiwyg','validation'=>'string|min:5','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
			$this->form[] = ['label'=>'Gambar','name'=>'gambar','type'=>'upload','validation'=>'required|image|max:3000','width'=>'col-sm-10'];
			# END FORM DO NOT REMOVE THIS LINE

			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Nama Lokasi","name"=>"nama_lokasi","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
	    ...
	    */
	    public function hook_before_add(&$postdata) {        
	        ...
	        $postdata['id_kota'] = $kota->id_kota;
	        $postdata['kota'] = $kota->nama;
	        $postdata['kode_pos'] = $kota->kode_pos;
	        // dd($postdata);
