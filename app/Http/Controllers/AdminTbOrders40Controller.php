<?php namespace App\Http\Controllers;
	...
	class AdminTbOrders40Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Nama Toko","name"=>"id_customer","join"=>"tb_tokos,nama_toko"];
			...
			$this->col[] = ["label"=>"Tanggal Approve","name"=>"tanggal_approve"];
			...
			$this->form[] = ['label'=>'Tanggal Order','name'=>'tanggal_order','type'=>'hidden','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'No Order','name'=>'no_order','type'=>'hidden','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'SO to','name'=>'so_to','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'Self Pickup;Origin Shipment;Ambil Di Indomart'];
			$this->form[] = ['label'=>'Tipe Order','name'=>'tipe_order','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Total Bayar','name'=>'total_bayar','type'=>'hidden','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Status','name'=>'status','type'=>'hidden','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Privilleges','name'=>'id_privilleges','type'=>'hidden','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Order By','name'=>'order_by','type'=>'hidden','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Tipe Harga Jual','name'=>'tipe_harga_jual','type'=>'hidden','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'SO to','name'=>'so_to','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'No Order','name'=>'no_order','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10','readonly'=>'1'];
			$this->form[] = ['label'=>'User','name'=>'nama_depan','type'=>'select2','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Biaya Layanan','name'=>'biaya_layanan','type'=>'money','validation'=>'min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Total Bayar','name'=>'total_bayar','type'=>'money','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Customer Existing','name'=>'id_customer','type'=>'select2','validation'=>'integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Customer Existing','name'=>'nama_customer','type'=>'select2','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Nama Depan','name'=>'nama_depan','type'=>'text','validation'=>'min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Nama Belakang','name'=>'nama_belakang','type'=>'text','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			$this->form[] = ['label'=>'No Handphone','name'=>'no_handphone','type'=>'text','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Provinsi','name'=>'id_primary','type'=>'select','validation'=>'integer','width'=>'col-sm-10','datatable'=>'tb_master_kotas,nama','parent_select'=>'id_primary'];
			$this->form[] = ['label'=>'Kota','name'=>'id_kota','type'=>'select','validation'=>'integer','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Kode Pos','name'=>'kode_pos','type'=>'number','validation'=>'integer','width'=>'col-sm-10'];
	        ...
	        */
	        ...
	        $this->sub_module[] = ['label'=>'Details','path'=>'tb_order_details','parent_columns'=>'no_order,nama_customer','foreign_key'=>'id_order','button_color'=>'success','button_icon'=>'fa fa-bars'];
	        $this->sub_module[] = ['label'=>'Checking','path'=>'tb_order_checks','parent_columns'=>'no_order,nama_customer','foreign_key'=>'id_order','button_color'=>'success','button_icon'=>'fa fa-bars'];
