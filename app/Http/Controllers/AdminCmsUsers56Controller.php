<?php namespace App\Http\Controllers;
	...
	class AdminCmsUsers56Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Name","name"=>"name","join"=>"tb_tokos,id_user"];
			$this->col[] = ["label"=>"Photo","name"=>"photo","image"=>true];
			$this->col[] = ["label"=>"Email","name"=>"email","join"=>"tb_tokos,email"];
			$this->col[] = ["label"=>"Privileges","name"=>"id_cms_privileges","join"=>"cms_privileges,name"];
			$this->col[] = ["label"=>"Sales","name"=>"id_sales","join"=>"tb_tokos,nama_toko"];
			$this->col[] = ["label"=>"Id","name"=>"id","join"=>"tb_tokos,nama_toko"];
