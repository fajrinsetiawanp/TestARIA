<?php namespace App\Http\Controllers;
	...
	class AdminTbJasaKirimWholesalesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "tb_jasa_kirim_wholesales";
			...
			$this->form[] = ['label'=>'Kota','name'=>'kota','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'tb_master_kotas,nama'];
	    ...
	    */
	    public function hook_before_add(&$postdata) {        
	        //Your code here
	        $kota = TbMasterKota::find($postdata['kota']);
