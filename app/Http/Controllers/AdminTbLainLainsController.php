<?php namespace App\Http\Controllers;
	...
	class AdminTbLainLainsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Judul','name'=>'judul','type'=>'select2','validation'=>'required|string|min:3|max:70','width'=>'col-sm-10','dataenum'=>'About;T & C;Visi;Misi'];
