...
namespace App\Http\Controllers;
	...
	class AdminTbArtikelsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Deskripsi Singkat','name'=>'deskripsi_singkat','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Kategori Artikel','name'=>'id_kategori_artikel','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'tb_kategori_artikels,nama_kategori'];
			...
			//$this->form[] = ["label"=>"Kategori Artikel","name"=>"id_kategori_artikel","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"kategori_artikel,id"];
	        ...
	        */
	        ...
	        $this->addaction[] = ['label'=>'Set Aktif','url'=>CRUDBooster::mainpath('set-status/aktif/[id]'),'icon'=>'fa fa-check','color'=>'success','showIf'=>"[status] == 'Tidak Aktif'", 'confirmation' => true];
	        $this->addaction[] = ['label'=>'Set Tidak Aktif','url'=>CRUDBooster::mainpath('set-status/tidak-aktif/[id]'),'icon'=>'fa fa-ban','color'=>'warning','showIf'=>"[status] == 'Aktif'", 'confirmation' => true];
