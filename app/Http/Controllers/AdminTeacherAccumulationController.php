<?php namespace App\Http\Controllers;
	...
	class AdminTeacherAccumulationController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"This Month's Accumulation","name"=>"id"];
	    ...
	    */    
	    public function hook_row_index($column_index,&$column_value) {	        
	    	...
	    	if ($column_index == 4) {
	    		...
	    		$order_teacher = TbOrderTeacher::where('order_by', $column_value)->whereBetween('tanggal_order', [$from, $to])->where('status', 'Hold')->get();
	    		// dd($order_teacher);
	    	}
	    }
