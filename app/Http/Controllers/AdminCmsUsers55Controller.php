<?php
 ...
 namespace App\Http\Controllers;
	...
	class AdminCmsUsers55Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Name","name"=>"name","join"=>"cms_users,id"];
			$this->col[] = ["label"=>"Email","name"=>"email","join"=>"cms_users,email"];
			...
			$this->col[] = ["label"=>"Location Branch","name"=>"location_branch"];
			...
			$this->form[] = ['label'=>'Location Branch','name'=>'location_branch','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
	        ...
	        */
	        ...
	        $this->addaction[] = ['label' => 'Set Active', 'url' => 'cms_users55/set-status-teacher/Active/[id]', 'icon' => 'fa fa-check', 'color' => 'success', 'showIf' => "[status] == 'Not Active'", 'confirmation' => true];
	        $this->addaction[] = ['label' => 'Set Not Active', 'url' => CRUDBooster::mainpath('set-status-teacher/NotActive/[id]'), 'icon' => 'fa fa-ban', 'color' => 'warning', 'showIf' => "[status] == 'Active'", 'confirmation' => true];
	    ...
	    */
	    public function hook_query_index(&$query) {
	        //Your code here
	        $query->where('id_cms_privileges', 8);
