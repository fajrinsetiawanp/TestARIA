<?php namespace App\Http\Controllers;
	...
	class AdminTbMasterEcommerces52Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "tb_master_ecommerces";
			...
			$this->form = [];
			$this->form[] = ['label'=>'Produk','name'=>'id_produk','type'=>'hidden','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Nama','name'=>'nama','type'=>'select2','validation'=>'required|string|min:3|max:70','width'=>'col-sm-10','dataenum'=>'bukalapak;tokopedia;blibli;shopee;ilotte'];
