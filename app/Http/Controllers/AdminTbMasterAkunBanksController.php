<?php namespace App\Http\Controllers;
	...
	class AdminTbMasterAkunBanksController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "tb_master_akun_banks";
			...
			$this->form[] = ['label'=>'Deskripsi','name'=>'deskripsi','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'DOREMI;MUSIKA'];
			// $this->form[] = ['label'=>'Deskripsi','name'=>'deskripsi','type'=>'wysiwyg','validation'=>'string|min:5|max:5000','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"No Rekening","name"=>"no_rekening","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
